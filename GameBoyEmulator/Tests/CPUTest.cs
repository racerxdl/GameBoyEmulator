    ...
    public class CPUTest {
        ...
        public void NOP() {
            ...
            for (var i = 0; i < RUN_CYCLES; i++) {
                ...
                CPUInstructions.opcodes[0x00](cpu);
        ...
        public void LDBCnn() {
            ...
            for (var i = 0; i < RUN_CYCLES; i++) {
                ...
                #region Test Cycles
                Assert.AreEqual(12, regAfter.lastClockT);
                Assert.AreEqual(3, regAfter.lastClockM);
                #endregion
        ...
        #endregion
        #region 0x03 Test INC BC
        [Test]
        public void INCBC() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0x03) \"INC BC\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x03](cpu);
                var regAfter = cpu.reg.Clone();

                var valA = (byte) (regBefore.C + 1);
                var valB = (byte) (valA == 0 ? regBefore.B + 1 : regBefore.B);

                Assert.AreEqual(valA, regAfter.C);
                Assert.AreEqual(valB, regAfter.B);
        ...
        public void LDmmSP() {
            ...
            for (var i = 0; i < RUN_CYCLES; i++) {
                ...
                #region Test Cycles
                Assert.AreEqual(20, regAfter.lastClockT);
                Assert.AreEqual(5, regAfter.lastClockM);
                #endregion
        ...
        #endregion
        #region 0x0b Test DEC BC
        [Test]
        public void DECBC() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0x0b) \"DEC BC\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x0b](cpu);
                var regAfter = cpu.reg.Clone();

                var valA = (byte) (regBefore.C - 1);
                var valB = (byte) (valA == 255 ? regBefore.B - 1 : regBefore.B);
        ...
        public void Stop() {
            ...
            for (var i = 0; i < RUN_CYCLES; i++) {
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x10](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0x13 Test INC DE
        [Test]
        public void INCDE() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0x13) \"INC DE\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x13](cpu);
                var regAfter = cpu.reg.Clone();

                var valA = (byte) (regBefore.E + 1);
                var valB = (byte) (valA == 0 ? regBefore.D + 1 : regBefore.D);

                Assert.AreEqual(valA, regAfter.E);
                Assert.AreEqual(valB, regAfter.D);
        ...
        #endregion
        #region 0x18 Test JR r8
        [Test]
        public void JRn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0x18) \"JR r8\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x18](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0x1b Test DEC DE
        [Test]
        public void DECDE() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0x1b) \"DEC DE\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x1b](cpu);
                var regAfter = cpu.reg.Clone();

                var valA = (byte) (regBefore.E - 1);
                var valB = (byte) (valA == 255 ? regBefore.D - 1 : regBefore.D);
        ...
        #endregion
        #region 0x20 Test JR NZ, r8
        [Test]
        public void JRNZn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0x20) \"JR NZ, r8\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x20](cpu);
                var regAfter = cpu.reg.Clone();

                if (!regBefore.FlagZero) {
                    Assert.AreEqual((regBefore.PC + signedV + 1) & 0xFFFF, regAfter.PC);
                    Assert.AreEqual(regAfter.lastClockT, 12);
                    Assert.AreEqual(regAfter.lastClockM, 12 / 4);
                } else {
                    Assert.AreEqual(regBefore.PC + 1, regAfter.PC);
                    Assert.AreEqual(regAfter.lastClockT, 8);
                    Assert.AreEqual(regAfter.lastClockM, 8 / 4);
                }
        ...
        #endregion
        #region 0x23 Test INC HL
        [Test]
        public void INCHL() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0x23) \"INC HL\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x23](cpu);
                var regAfter = cpu.reg.Clone();

                var valA = (byte) (regBefore.L + 1);
                var valB = (byte) (valA == 0 ? regBefore.H + 1 : regBefore.H);

                Assert.AreEqual(valA, regAfter.L);
                Assert.AreEqual(valB, regAfter.H);
        ...
        #endregion
        #region 0x28 Test JR Z,r8
        [Test]
        public void JRZn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0x28) \"JR Z,r8\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x28](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0x2b Test DEC HL
        [Test]
        public void DECHL() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0x2b) \"DEC HL\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x2b](cpu);
                var regAfter = cpu.reg.Clone();

                var valA = (byte) (regBefore.L - 1);
                var valB = (byte) (valA == 255 ? regBefore.H - 1 : regBefore.H);
        ...
        #endregion
        #region 0x30 Test JR NC, r8
        [Test]
        public void JRNCn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0x30) \"JR NC, r8\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x30](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0x36 Test LD [HL], d8
        [Test]
        public void LDHLmn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0x36) \"LD [HL], d8\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x36](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0x38 Test JR C, r8
        [Test]
        public void JRCn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0x38) \"JR C, r8\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x38](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        public void HALT() {
            ...
            for (var i = 0; i < RUN_CYCLES; i++) {
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0x76](cpu);
                var regAfter = cpu.reg.Clone();

                Assert.IsTrue(cpu._halt);
        ...
        #endregion
        #region 0xc0 Test RET NZ
        [Test]
        public void RETNZ() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xc0) \"RET NZ\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xc0](cpu);
                var regAfter = cpu.reg.Clone();

                if (!regBefore.FlagZero) {
                    Assert.AreEqual(valA, regAfter.PC);
                    Assert.AreEqual(20, regAfter.lastClockT);
                    Assert.AreEqual(20 / 4, regAfter.lastClockM);
                    Assert.AreEqual(regBefore.SP + 2, regAfter.SP);
                } else {
                    Assert.AreEqual(8, regAfter.lastClockT);
                    Assert.AreEqual(8 / 4, regAfter.lastClockM);
        ...
        #endregion
        #region 0xc1 Test POP BC
        [Test]
        public void POPBC() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xc1) \"POP BC\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xc1](cpu);
                var regAfter = cpu.reg.Clone();

                Assert.AreEqual(regBefore.SP + 2, regAfter.SP);
                Assert.AreEqual(valA, regAfter.B);
                Assert.AreEqual(valB, regAfter.C);
        ...
        #endregion
        #region 0xc2 Test JP NZ, a16
        [Test]
        public void JPNZnn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xc2) \"JP NZ, a16\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xc2](cpu);
                var regAfter = cpu.reg.Clone();

                if (!regBefore.FlagZero) {
                    Assert.AreEqual(valA, regAfter.PC);
                    Assert.AreEqual(regAfter.lastClockT, 16);
                    Assert.AreEqual(regAfter.lastClockM, 16 / 4);
                } else {
                    Assert.AreEqual(regBefore.PC + 2, regAfter.PC);
                    Assert.AreEqual(regAfter.lastClockT, 12);
                    Assert.AreEqual(regAfter.lastClockM, 12 / 4);
        ...
        #endregion
        #region 0xc3 Test JP a16
        [Test]
        public void JPnn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xc3) \"JP a16\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xc3](cpu);
                var regAfter = cpu.reg.Clone();
                ...
                #region Test Cycles
                Assert.AreEqual(16, regAfter.lastClockT);
                Assert.AreEqual(4, regAfter.lastClockM);
                #endregion
        ...
        #endregion
        #region 0xc4 Test CALL NZ,a16
        [Test]
        public void CALLNZnn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xc4) \"CALL NZ,a16\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xc4](cpu);
                var regAfter = cpu.reg.Clone();

                if (!regBefore.FlagZero) {
                    Assert.AreEqual(valA, regAfter.PC);
                    Assert.AreEqual(regAfter.lastClockT, 24);
                    Assert.AreEqual(regAfter.lastClockM, 24 / 4);
                    Assert.AreEqual(regBefore.SP - 2, regAfter.SP);
                } else {
                    Assert.AreEqual(regBefore.PC + 2, regAfter.PC);
                    Assert.AreEqual(regAfter.lastClockT, 12);
        ...
        #endregion
        #region 0xc5 Test PUSH BC
        [Test]
        public void PUSHBC() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xc5) \"PUSH BC\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xc5](cpu);
                var regAfter = cpu.reg.Clone();
                ...
                Assert.AreEqual(regBefore.SP - 2, regAfter.SP);
                Assert.AreEqual(regBefore.B, valA);
                Assert.AreEqual(regBefore.C, valB);
        ...
        #endregion
        #region 0xc8 Test RET Z
        [Test]
        public void RETZ() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xc8) \"RET Z\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xc8](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        public void RET() {
            ...
            for (var i = 0; i < RUN_CYCLES; i++) {
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xc9](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xca Test JP Z,a16
        [Test]
        public void JPZnn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xca) \"JP Z,a16\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xca](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xcc Test CALL Z,a16
        [Test]
        public void CALLZnn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xcc) \"CALL Z,a16\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xcc](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xcd Test CALL a16
        [Test]
        public void CALLnn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xcd) \"CALL a16\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xcd](cpu);
                var regAfter = cpu.reg.Clone();
                ...
                #region Test Cycles
                Assert.AreEqual(24, regAfter.lastClockT);
                Assert.AreEqual(6, regAfter.lastClockM);
                #endregion
        ...
        #endregion
        #region 0xd0 Test RET NC
        [Test]
        public void RETNC() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xd0) \"RET NC\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xd0](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xd1 Test POP DE
        [Test]
        public void POPDE() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xd1) \"POP DE\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xd1](cpu);
                var regAfter = cpu.reg.Clone();

                Assert.AreEqual(regBefore.SP + 2, regAfter.SP);
                Assert.AreEqual(valA, regAfter.D);
                Assert.AreEqual(valB, regAfter.E);
        ...
        #endregion
        #region 0xd2 Test JP NC,a16
        [Test]
        public void JPNCnn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xd2) \"JP NC,a16\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xd2](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xd3 Test UNDEFINED
        [Test]
        public void NOPWARN_d3() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xd3) \"UNDEFINED\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xd3](cpu);
                var regAfter = cpu.reg.Clone();
                ...
                #region Test Cycles
                Assert.AreEqual(0, regAfter.lastClockT);
                Assert.AreEqual(0, regAfter.lastClockM);
                #endregion
        ...
        #endregion
        #region 0xd4 Test CALL NC, a16
        [Test]
        public void CALLNCnn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xd4) \"CALL NC, a16\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xd4](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xd5 Test PUSH DE
        [Test]
        public void PUSHDE() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xd5) \"PUSH DE\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xd5](cpu);
                var regAfter = cpu.reg.Clone();
                ...
                Assert.AreEqual(regBefore.SP - 2, regAfter.SP);
                Assert.AreEqual(regBefore.D, valA);
                Assert.AreEqual(regBefore.E, valB);
        ...
        #endregion
        #region 0xd8 Test RET C
        [Test]
        public void RETC() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xd8) \"RET C\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xd8](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        public void RETI() {
            ...
            for (var i = 0; i < RUN_CYCLES; i++) {
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xd9](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xda Test JP C, a16
        [Test]
        public void JPCnn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xda) \"JP C, a16\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xda](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xdb Test UNDEFINED
        [Test]
        public void NOPWARN_db() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xdb) \"UNDEFINED\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xdb](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xdc Test CALL C, a16
        [Test]
        public void CALLCnn() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xdc) \"CALL C, a16\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xdc](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xdd Test UNDEFINED
        [Test]
        public void NOPWARN_dd() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xdd) \"UNDEFINED\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xdd](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xe1 Test POP HL
        [Test]
        public void POPHL() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xe1) \"POP HL\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xe1](cpu);
                var regAfter = cpu.reg.Clone();

                Assert.AreEqual(regBefore.SP + 2, regAfter.SP);
                Assert.AreEqual(valA, regAfter.H);
                Assert.AreEqual(valB, regAfter.L);
        ...
        #endregion
        #region 0xe3 Test UNDEFINED
        [Test]
        public void NOPWARN_e3() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xe3) \"UNDEFINED\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xe3](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xe4 Test UNDEFINED
        [Test]
        public void NOPWARN_e4() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xe4) \"UNDEFINED\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xe4](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xe5 Test PUSH HL
        [Test]
        public void PUSHHL() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xe5) \"PUSH HL\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xe5](cpu);
                var regAfter = cpu.reg.Clone();
                ...
                Assert.AreEqual(regBefore.SP - 2, regAfter.SP);
                Assert.AreEqual(regBefore.H, valA);
                Assert.AreEqual(regBefore.L, valB);
        ...
        #endregion
        #region 0xe9 Test JP [HL]
        [Test]
        public void JPHL() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xe9) \"JP [HL]\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xe9](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xeb Test UNDEFINED
        [Test]
        public void NOPWARN_eb() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xeb) \"UNDEFINED\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xeb](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xec Test UNDEFINED
        [Test]
        public void NOPWARN_ec() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xec) \"UNDEFINED\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xec](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xed Test UNDEFINED
        [Test]
        public void NOPWARN_ed() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xed) \"UNDEFINED\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xed](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xf1 Test POP AF
        [Test]
        public void POPAF() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xf1) \"POP AF\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xf1](cpu);
                var regAfter = cpu.reg.Clone();

                Assert.AreEqual(regBefore.SP + 2, regAfter.SP);
                Assert.AreEqual(valA, regAfter.A);
                Assert.AreEqual(valB, regAfter.F);
        ...
        public void DI() {
            ...
            for (var i = 0; i < RUN_CYCLES; i++) {
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xf3](cpu);
                var regAfter = cpu.reg.Clone();

                Assert.IsFalse(regAfter.InterruptEnable);
        ...
        #endregion
        #region 0xf4 Test UNDEFINED
        [Test]
        public void NOPWARN_f4() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xf4) \"UNDEFINED\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xf4](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xf5 Test PUSH AF
        [Test]
        public void PUSHAF() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xf5) \"PUSH AF\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xf5](cpu);
                var regAfter = cpu.reg.Clone();
                ...
                Assert.AreEqual(regBefore.SP - 2, regAfter.SP);
                Assert.AreEqual(regBefore.A, valA);
                Assert.AreEqual(regBefore.F, valB);
        ...
        public void EI() {
            ...
            for (var i = 0; i < RUN_CYCLES; i++) {
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xfb](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xfc Test UNDEFINED
        [Test]
        public void NOPWARN_fc() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xfc) \"UNDEFINED\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xfc](cpu);
                var regAfter = cpu.reg.Clone();
        ...
        #endregion
        #region 0xfd Test UNDEFINED
        [Test]
        public void NOPWARN_fd() {
            var cpu = new CPU();
            var random = new Random();
            Console.WriteLine("Testing (0xfd) \"UNDEFINED\"");
            for (var i = 0; i < RUN_CYCLES; i++) {
                cpu.Reset();
                cpu.reg.RandomizeRegisters();
                cpu.memory.RandomizeMemory();
                ...
                var regBefore = cpu.reg.Clone();
                CPUInstructions.opcodes[0xfd](cpu);
                var regAfter = cpu.reg.Clone();
