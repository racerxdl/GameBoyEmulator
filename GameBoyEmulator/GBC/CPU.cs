...
namespace GameBoyEmulator.Desktop.GBC {
    public class CPU {
        ...
        private static readonly List<Action<CPU>> opcodes = new List<Action<CPU>> {
            ...
            (cpu) => CPUInstructions.INCr(cpu, "B", "C", "A"),
            ...
            (cpu) => CPUInstructions.DECBC(cpu),
            (cpu) => CPUInstructions.INCr(cpu),
            (cpu) => CPUInstructions.DECr(cpu),
            ...
            (cpu) => CPUInstructions.INCDE(cpu, "D", "E"),
            ...
            (cpu) => CPUInstructions.INCr_h(cpu, "H"),
            (cpu) => CPUInstructions.DECr_h(cpu, "H"),
